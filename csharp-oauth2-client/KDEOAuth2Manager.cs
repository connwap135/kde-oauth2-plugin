    ...
    public class KDEOAuth2Manager
    {
        ...
        public async Task<Dictionary<string, object>> GetDatabaseStatsAsync()
        {
            ...
            try
            {
                ...
                stats["total_accounts"] = await totalAccountsCommand.ExecuteScalarAsync();
                ...
                stats["oauth2_accounts"] = await oauth2AccountsCommand.ExecuteScalarAsync();
                ...
                stats["enabled_accounts"] = await enabledAccountsCommand.ExecuteScalarAsync();
